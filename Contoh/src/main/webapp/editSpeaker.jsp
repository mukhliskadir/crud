...
<%
    ...
    String sql= "select * from spk where spkid='"+num+"'";
...
<div class="content">
    ...
    <div class="custform">
        <form class="speaker" method="post">
            <input type="hidden" name="id" value='<%=rs.getString("spkid") %>'/>
            <div class="dataa">
                <label>   Name </label>
                <input type="text" name="speakerName" value='<%=rs.getString("spkname") %>' required>
            </div>
            <div class="dataa">
                <label>  Phone</label>
                <input type="text" name="speakerPhone" value='<%=rs.getString("spkphone") %>'>
            </div>
            <div class="dataa">
                <label>    Education</label>
                <input type="text" name="speakerEdu" value='<%=rs.getString("spkedu") %>'>
            </div>
            <%} %>
